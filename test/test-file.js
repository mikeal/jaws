...
app.route('/static/mapleTree/match.js').file(path.join(__dirname, '..', 'node_modules', 'mapleTree', 'match.js'))

app.httpServer.listen(8080, function () {
  assert.equal(0, Object.keys(app.lru.dump()).length)
  request.get('http://localhost:8080/static/mapleTree/match.js', function (e, resp, body) {
    if (e) throw e
